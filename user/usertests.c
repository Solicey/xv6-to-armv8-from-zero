...
void copyin(char* s)
{
    uint64 addrs[] = { 0xffff000040000000, 0xffffffffffffffff };
...
void rwsbrk()
{
    ...
    if ((uint64)sbrk(-8192) == 0xffffffffffffffff)
    {
...
void kernmem(char* s)
{
    ...
    for (a = (char*)(0xffff000040000000); a < (char*)(0xffff000048000000); a += 50000)
    {
        pid = fork();
        if (pid < 0)
        {
...
void badarg(char* s)
{
    ...
    {
        char* argv[2];
        argv[0] = (char*)0xffff000040000000;
        argv[1] = 0;
        exec("echo", argv);
    }
...
void badwrite(char* s)
{
    ...
    for (int i = 0; i < assumed_free; i++)
    {
        ...
        write(fd, (char*)0xffffffffffffffffL, 1);
        close(fd);
        unlink("junk");
    }
